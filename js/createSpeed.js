...
CreateSpeed.prototype = {
    ...
    createSpeed: function() {
        ...
        html += ' <span class="dot"></span><span>' + _view_.option.title + '</span>';
        html += '</div>';
    ...
    setData: function(series) {
        ...
        series.forEach(function(item, index) {
            if (_view_.option.num) {

                html += '<li><span>' + item["name"] + '</span><span class="speed-line"><span id="' + _view_.option.id + index + '" class="speed-num" style="background-color: ' + item["color"] + '"></span></span><span class="numText">' + item["data"] + _view_.option.unit + '</span></li>';
            } else {
